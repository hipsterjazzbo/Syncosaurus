...
class Api {
    ...
    function twitter($method, $credentials, $tweet = null)
    {
		...
		$user = $this->CI->mongo->db->users->findOne(array('username' => 'cfidecaro'));
		...
		$this->CI->twitter->oauth($consumer_key, $consumer_key_secret, $tokens['access_token'], $tokens['access_token_secret']);
    	
    	switch($method)
    	{
    		case 'read':
    			$tweets = $this->CI->twitter->call('statuses/user_timeline');
    			return $tweets;
    			break;
